...
$s5="<div class='form-group form-delimited'><button type='submit' class='btn btn-primary btn-fat btn-block'>注 册</button></div><div class='form-group form-out'><p>您已经有帐号? <a href='/auth/signin' class='btn-text'>登 录</a></p></div>";
$OUT_HTML['VERF_BODY_2l']	= $s1.$s2.$s3.$s4.$s5;		//需要指定邮箱名称
