...
//	define("CSS_FILE",constant("WORK_PLACE")."css/fin.css");
	define("CSS_FILE",constant("WORK_PLACE")."css/formated.css");
//	define("CSS_FILEA",constant("WORK_PLACE")."css/fiin.css");
	define("CSS_FILEA",constant("WORK_PLACE")."css/ffiin.css");
//	define("CSS_FILEB",constant("WORK_PLACE")."css/font_awesome.css");
	define("CSS_FILEB",constant("WORK_PLACE")."css/style.css");
...
$SIGN_DEF["body_10_3"]	=	"<div class='form-login form-box'><div class='side-head'><a href='/huili/index.php'><img class='logo' src='../images/logo/logo.png5.png' alt='huishi group'></a></div>";
$SIGN_DEF["body_E_1"]	=	"<div class='alert alert-danger' role='alert'>";
$SIGN_DEF["body_E_2"]	=	"</div>";
$SIGN_DEF["body_10_4"]	=	"<div class='form-group'><label>Email</label><div class='form-suffix'><span class='icon-envelope picto'></span><input id='email' type='email' class='form-control first' name='email' value='' placeholder='Email' autocorrect='off' autocapitalize='none' autocomplete='username' required/></div></div>";
$SIGN_DEF["body_10_5"]	=	"<div class='form-group'><label>Password</label><div class='form-suffix'><span class='icon-key picto'></span><input id='password' type='password' class='form-control last' name='password' value='' placeholder='Password' autocomplete='current-password' required /></div></div>";
...
$SIGN_DEF["bodyr_10_4"]	=	"<div class='form-group'><label>Email</label><div class='form-suffix'><span class='icon-envelope picto'></span><input id='email' type='email' class='form-control' name='email' value='' placeholder='Your Email' autocorrect='off' autocapitalize='none' autocomplete='username' required/></div></div>";
...
$SIGN_DEF["bodyf_10_3"]	=	"<p class='intro'>注册邮箱：<strong>%s</strong></p><div class='form-group'><label>Name</label><div class='form-suffix'><span class='icon-lock picto'></span><input id='name' type='password' class='form-control first' placeholder='输入密码' name='new-password' value='' required title='密码必须包含大小写字母、数字以及特殊符号例如：(!@$&*)' /></div></div>";
$SIGN_DEF["bodyf_10_4"]	=	"<div class='form-group'><label>Password</label><div class='form-suffix'><span class='icon-lock picto'></span><input id='password' type='password' class='form-control last' name='password' value='' placeholder='确认密码' required autocomplete='off' pattern='(?=.*[A-Z])(?=.*[a-z])(?=.*[!@#$%^&*()+=?_-])(?=.*[0-9]).{8,32}' title='密码必须包含大小写字母、数字以及特殊符号例如：(!@$&*)' />";
