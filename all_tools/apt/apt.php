...
echo "<font size=3 color=black>一、apt源的配置文件为：/etc/apt/sources.list,我现在使用的源是163的一般配置如下：<br>";
echo "#deb cdrom:[Debian GNU/Linux 6.0.2.1 _Squeeze_ - Official i386 NETINST Binary-1 20110628-13:01]/ squeeze main<br>";
echo "deb http://mirrors.163.com/debian/ squeeze main non-free contrib<br>deb-src http://mirrors.163.com/debian/ squeeze main non-free contrib</font><br>";
