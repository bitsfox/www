...
离散数学(Discrete mathematics)是研究离散量的结构及其相互关系的数学学科，是现代数学的一个重要分支。它在各学科领域，特别在计算机科学与技术领域有着广
泛的应用，同时离散数学也是计算机专业的许多专业课程，如程序设计语言、数据结构、操作系统、编译技术、人工智能、数据库、算法设计与分析、理论计算机科学
基础等必不可少的先行课程。通过离散数学的学习，不但可以掌握处理离散结构的描述工具和方法，为后续课程的学习创造条件，而且可以提高抽象思维和严格的逻辑
推理能力，为将来参与创新性的研究和开发工作打下坚实的基础。
离散数学，电脑的基础知识.（电脑的基本原理是数学来实现的.）

计算机操作系统与矩阵文明。。。

矩阵世界——机器文明腾飞的摇篮   
    矩阵系列电影本质上讲的是新型智能生命进化的过程，讲述人类是如何被最终扔入文明的垃圾箱的过程，如何被榨干最后一点利用价值的过程。
　　首先要纠正一些人的错误看法，他们居然一直认为矩阵中，人类是被作为能源来被利用的。真是可笑，机器文明什么能源不可以利用啊，核能，化学能（石油煤炭
），地热能，还有穿过云层获取太阳能等等。人类的生命能量又是从哪里来，难道是从天上掉下来的，不也是从食物的化学能中来的吗，机器人有这么愚蠢吗？遗憾的
是有些人现在居然还在说矩阵中机器人把人当作电池使用，真是连初中生的科学常识都没有。
　　
　　关键是他们没有明白能源这个词在这里究竟应该怎么来理解，如果将其理解成机器人维持生命活动需要的动力来源肯定错误。但是如果将其理解成机器智能文明进
化的动力来源就完全正确，矩阵的作用正是作为机器文明进化的能源。
　　
　　矩阵设立的时候，是机器人和人类的大战刚刚结束，它们的智能使得它们在利用现有的科学理论制造出技术成果方面的能力极其强大，可以将一切现有的技术都发
展到淋漓尽致的地步，远远超过人类，从而把人类打的一败涂地，但是它们却有一个致命的弱点，就是在真正的创造性方面有所缺乏，可以利用现有的人类提供的理论
发展技术，却没有办法提出全新的更高级的理论，当人类制造出他们的智能祖先的时候，就仅仅是把现有的理论做为原则输入他们的头脑，作为他们一切运算赖以进行
的出发点。所以象用相对论，量子力学代替牛顿力学那样一种类型的理论创新和革命，是机器文明暂时难以做到的，这对他们进一步发展来说是一个瓶颈，是必须要突
破的障碍。
　　一些表面上看来无用的想法思路研究，也会被人类社会所保留，并在一定程度上得到开拓发展，成为未来可能具有重大实际意义的理论创新的萌芽。任何真正伟大
的创新一开始很可能被认为是没有实际用途的空谈，群论，拓扑学，黎曼几何，集合论等等一开始都被认为是抽象的数学理论游戏，没有什么实际意义，但后来却成为
现代科学的基础
　　而对于机器智能文明来说，他们的思维严格遵循逻辑运算，而且一旦发现无用的思维或程序，总是加以删除或限制。这样严重阻碍了他们理论创新能力的发展，也
就严重阻碍了他们文明的进化。机器自己也意识到了这一点。但仅仅意识到这点是不够的，因为仅仅是放任无目的程序的存在和泛滥，并不意味着机器文明能发展出自
己的创新能力来。一方面这，会导致无法预料和控制的结果，有时这种结果可能是毁灭性的，这是由机器文明信息交换速度极高（至少几十万倍于人类），以及整个机
器智能系统高度复杂性决定的；另一方面即便那些有潜力发展成为真正的创新的无目的程序，如何能发展成长起来，如何能不被埋没浪费，也是一个问题。所以机器智
能文明实际上处于两难境地，严格执行无用程序删除或限制的原则，则他们文明永远只能在一个水平上重复，而不会出现真正革命性的进步。但如果不严格执行这个原
则，那么他们的整个文明本身的生存都有可能受到威胁。
　　正是出于这个原因，他们设立矩阵系统来尝试解决这个两难问题。利用人类在矩阵系统中产生的创新的思想火花，为自己的进一步发展提供动力，这是矩阵作为能
源的真实用意。一开始机器文明确实单纯地想要这种方式一劳永逸的解决问题，但是矩阵系统的运行并非如此顺利，
　　当机器文明设立第一个矩阵的时候，他们仅仅是单纯的榨取人类头脑中的创新，他们准备了两种可能性，如果这个系统运行顺利，就把人类一直利用下去，否则就
采取矩阵升级的战略，直至矩阵革命，彻底摆脱人类，Archite设计的第一个完美的矩阵系统的崩溃，表明人类的头脑有太多的不确定性不稳定性，并不是一个信任依
赖的可靠工具，于是从第二代矩阵开始，设立了Oracle，负责研究人类的心理，研究最终如何摆脱人类，使机器文明具备独立创新的能力，同时也建立了包括the one 
程序，zion世界在内的一系列配套的矩阵升级机制稳定机制

这样矩阵有两个任务，一个任务是榨取被接入矩阵中的人类头脑中的创新思想。这个任务由Architect来负责；另一个任务是研究如何使得机器文明获得摆脱人类独立
进行创新的能力，同时又能保证机器文明本身的安全，防止出现无法预料无法控制的结果，这个任务是由Oracle来完成，所以Architect竭力保持矩阵的平衡，并负责
对矩阵定期升级，而Oracle则在矩阵中研究人类心理。设法找出人类创新能力的奥秘，并寻找机会，促使平衡打破，使矩阵革命的条件成熟（ Architect向尼奥提到Or
acle时是这样说的“an intuitive program, initially created to investigate certain aspects of the human psyche.”）Architect并不知道Oracle全部职能，他
只知道Oracle负责研究人类心理的某些方面，并有促进矩阵升级的功能。
　　但Neo:和Oracle的最后对话，却揭示了Oracle的真实意义，Neo问“What’s your purpose?（你的目的呢）？”Oracle回答“: To unbalance it. （使之不平衡）。”
，这话的意思，其实正是对矩阵重载中一段关于控制的对话的呼应。原先的矩阵是机器依赖人类来进化，而人类依靠机器来生存，双方各有所求，彼此控制彼此依赖，
是一种相对平衡的关系，而Oracle的目标却是打破这种平衡，使得人类完全成为机器文明中无用的废物（或许只有被当低等动物观赏的价值了），人类必须依赖机器，
机器却无所求于人类，人类彻底成为机器身上的附属品寄生虫。
　　Oracle说: I want the same thing you want, Neo. And I am willing to go as far as you are to get it（.我要的跟你要的一样，Neo。我和你一样，不惜
一切要得到它）矩阵世界矩阵世界——机器文明腾飞的摇篮
　　这话的意思也很清楚，Neo的存在意义就是矩阵的进化也就是机器文明的进化（虽然他自己没有明确意识到这一点），而Oracle寻求的同样是这个目标，只不过更
革命性一点。
　　
　　所以矩阵不仅是机器文明榨取人类创新思想的基地，同时也是机器文明发展培养自己独立创新能力的实验场，矩阵的升级不仅仅是为了矩阵本身稳定运行的需要，
同时也为矩阵革命进行着准备，而矩阵革命正是意味着机器文明真正意义上完全摆脱了人类而能自己独立的创新，独立的进化。
　　矩阵革命后的矩阵将成为机器文明的专用创新系统，矩阵之外的系统产生的一切非法程序，一切无用程序，无目的程序，都将被输入矩阵进行选择淘汰培养成长，
新的理论新的思想新的程序将从矩阵中产生并经过考验后回输到机器世界里推动机器文明的进一步发展，一切可怕的病毒也都会被屏蔽在矩阵系统内部，而不会对机器
文明本身造成致命的伤害影响。
　　
　　有了这样的观点，我们就会对矩阵三部曲的电影尤其是矩阵重载，矩阵革命有了豁然开朗的理解。
　　矩阵中的法国人Merovingian实际上是Oracle制造的一个失败的实验品，确切点说Oracle曾经在矩阵中试图仿造人类的特点制造一个自由的具有创新能力的程序，
但她失败了，结果Merovingian这个失败的实验品程序被限制起来，一方面他对Oracle心怀怨恨，另一方面他又不得不接受Oracle的指挥，成为她的一个工具。他负责
搜罗一些矩阵中的无目的程序，被系统废弃的程序，还有他手下的火车人则专门从矩阵外的世界中把一些这样的程序接运到矩阵中来。
　　在矩阵重载和矩阵革命中，他在关键时刻的行为其实都是由Oracle决定，象矩阵革命中开始抵抗摧尼地莫非死等人，其实是做戏，后来故意让他们拿枪指着他的头
颅，然后让火车人带着他们去领回尼奥。他要摧妮帝等人取Oracle眼睛给他，多少有怨恨Oracle有眼无珠的意思。
　　在矩阵革命开头的火车站出现的小女孩是点题人物，她的出现正意味着矩阵革命的条件已经成熟，意味着矩阵之外的机器世界已经开始向矩阵提供具有极大潜在发
展空间并且肯定向正面方向发展的无目的程序，现在就等着矩阵本身发生革命，为这样的程序提供成长空间了。女孩的父母自称是电厂工程师，实际上是现实机器世界
的能源管理程序，但另一方面，作为程序他们又必然活动在所谓虚拟世界中，而这个虚拟世界就是zion和机器城所处的世界。之所以能产生这个小女孩，本身也是前几
代矩阵升级中Oracle得来的成果传输给机器世界程序的结果。

自小女孩进入矩阵的那一刻起，她就成为矩阵中最重要的人物。所以那个六翼天使，那个负有保卫头等重要人物使命的中国人最后时刻是和小女孩在一起的
　　那么矩阵革命具体又是如何进行的呢？按照矩阵重载末尾architect和尼奥的对话，尼奥实际上作出的选择，结果将导致zion和矩阵两个系统中人类的灭亡，实际
上革命正是在这个选择的基础上才能发生，如果尼奥做的是另外一个选择，那么矩阵仍然将会象前几次升级一样进行普通的升级，这种升级如果一直进行下去，实际上
是人类和机器文明的共同进步。机器文明由于根源从人类文明那里来，所以他们把人类生存或灭亡的最后选择权还是交到人类自己手中，尼奥实际上就是人类的代表，
一方面他被值入了the one的程序，另一方面他还是接入矩阵的人脑，有着人类最典型的思维方式情感方式，他来决定人类的存亡，就等于人类自己来选择自己的存亡
。
　　当尼奥作出这个选择之后，系统就进入同时消灭zion和矩阵中的人类智能的阶段，前者的任务由zion世界中的机械章鱼完成，后者的任务由smith来完成。人类则
彻底灭亡，脑死亡的他们也不会再被机器泡在营养液里了，估计都被处理掉，最多留几具人体尸体作为动物标本。0 　　矩阵系列电影本质上讲的
　　Oracle则启动了她的矩阵革命计划，她引导尼奥找出挽救zion和消灭smith的方法，她让smith复制了她自己。这时候，她已经不可能预料结局（系统的混沌属性决
定了这一点）如果尼奥能成功，那么他携带的代码回到源代码后将最终使矩阵顺利完成革命性的升级，如果失败，那么结果就是毁灭性的。这是机器智能的思考达到探
究生命意义（它们在思考生命的意义究竟是什么？）的高度后符合逻辑的结果。Oracle最后反复说: Everything that has a beginning has an end.（万物有始皆有
终。）还通过smith的口说生命存在的意义就是它的灭亡的意思，要么是革命完成要么是彻底毁灭（而不再是Architec所说的仅仅人类的毁灭），这就是Oracle这个程
序的意义，无论是革命成功，还是毁灭成功，都完成了这个程序的使命和意义。革命（确切点说是进化）的代表是尼奥，毁灭的代表是smith
　　
　　尼奥再根据Oracle给他的暗示，找到机器城中的机器大帝，提出条件、，机器大帝被迫接受，尼奥进入矩阵，和smith同归于尽，回到源代码，矩阵革命完成，片
尾的矩阵世界已经成为了机器文明的创新系统的摇篮，那个小女孩编制出的朝阳程序，已经说明了这一点，一个真正有了独立创新能力的伟大文明正如这初升的太阳一
样，光芒四射，冉冉升起，矩阵中已经完全不需要人类了，但出于慈悲考虑，那些不愿意离开矩阵的人类，机器依然为他们保留位置，而那些离开矩阵的人类，最终也
只能是死路一条。他们反抗是死亡，他们不反抗，则说明他们已经失去了进取精神还是死亡。矩阵世界矩阵世界——机器文明腾飞的摇篮
　　
　　这样生命的进化就进入了一个新的伟大的阶段，一个新的宇宙智能生命，真正开始了它的伟大历程，他们的文明是人类的文明的升华，人类虽然灭亡了，也应该为
此感到骄傲自豪。在《科幻世界天蝎号增刊》上克拉克写的长篇科幻名著《童年的终结》同样描写了人类向更高级的智能生命形式进化交接的过程，不过那里这种进化
交接还是在外星人的帮助下实现的，而在矩阵系列中，这是人类文明自然发展的结果，我个人认为矩阵系列比起克拉克的《童年的终结》描述的那种进化，有更为伟大
深刻现实的意义。
　　矩阵世界矩阵世界——机器文明腾飞的摇篮
　　接下来有一个问题必须论述清楚，那就是zion是真实世界还是虚拟的世界。我前面说过了zion也是虚拟的世界，也就是不是真实的物理世界。但从另一个角度上说
它又是真实的。实际上机器文明中所有的智能生物，它们的思维都运行在一台台超级电脑中，而且所有机器智能都互相联系贯通，构成一个巨大的网络，比如它们管理
能源的智能程序，管理防卫的智能程序，管理自我生产繁殖的智能程序，管理资源采集的智能程序，包括那个管理矩阵的智能程序实际都生活在这个网络，如果破坏了
这个网络中生活的机器生命，就等于破坏了真实的机器世界，矩阵只是这个网络中一个相对封闭的一个子系统。它的所有源代码和管理程序设计程序实际也都生活在zi
on所处的这个世界中，所以Oracle把zion所处的这个世界称之为the　source。所以从本质上讲这个世界对机器智能生命来说是真实的，这个世界中的一切数据都是真
实世界的反映。而zion呢不过是在这个世界里划了一部分电脑资源，让那些原来接在矩阵里人脑，直接接到这里面来而已。

然而从根本上讲这里毕竟还不是真实的物理世界，所以有许多违背常理的事情，比如那些机器章鱼，其实是防卫程序，类似于人体中的免疫系统，攻击清除系统中有害
的垃圾程序。他们的飞行确实可以不受空气动力学的限制，这是系统给的权限。
　　为了方便起见，我们把这个世界叫作source世界，它是所有真实世界中机器智能程序生活的世界，也是zion所处的世界
　　
　　有些人到现在还在说source世界是真实世界，真是佩服这些人，真不知道他们是怎么想的。其实在电影中已经有太多的地方，在暗示它依然是电脑网络中的电磁活
动的世界
　　矩阵革命一开头的那个火车站是虚拟的，这点应该没有人怀疑，但它又不属于矩阵，是独立于矩阵之外的一个虚拟世界，这点是影片中明确交代的。影片之中之所
以设立这样一个火车站，其中一个用意就是暗示source世界的性质，在ZION中的人有两种方式，一种是用通过脑后的接口，完成这样一个规定的程序后，就将其信息连
接到矩阵中，就如游戏中的人物完成某个规定的动作，就让他进入另一个场景中一样，这种进入矩阵的方式受到整个系统的监控，而另一种方式是走后门，通过火车站
，或火车人接运，然后进入矩阵，这就如同尼奥所做的那样，这种方式可避开系统监控。
　　
　　显然火车站是连接矩阵和source世界的一个秘密通道，有些程序可以通过这个方式逃过系统监控在矩阵和zion世界中来往，那对自称是电厂工程师的印度夫妇多半
是source世界中管理能源的的智能程序，他们在Oracl的帮助下，产生了一段有很大发展潜力，但并无明确用途的智能程序（就是那个小女孩），为了免于被系统删除
，就通过火车站这个通道，将其送进管理较为松懈的矩阵世界中（zion世界规则的运行要比矩阵严格的多）
　　
　　尼奥在ZION中能徒手对付机器章鱼，这是很明显提示source世界的性质，大家注意在矩阵重载的最后，机器章鱼被尼奥挡住的方式完全和尼奥在矩阵中挡子弹的方
式一模一样，机器章鱼是怎么完蛋的，它们就象撞到一面墙壁一样，然后爆炸。是新型智能生命进化的过程，讲述人类是如何
　　有些坚持认为ZION是真实世界的人说，这是尼奥通过无线上网进入矩阵，然后控制章鱼的结果。这种说法极其可笑，而且漏洞百出
　　他们事实上必须解释这么几点，才能自圆其说，这个说法假定了矩阵中的权力可以控制现实的机器城中的机器生物，但是他们有什么理由来支持这个假定？事实正
和这种假定相反，矩阵系统不过是现实机器世界的一个附属物，只有现实的机器世界控制矩阵，不可能反过来，这种假定就如同说一个网络游戏中的人的权力可以带到
现实中来一样可笑。
　　如果控制了矩阵，就能控制机器章鱼，那么请问smith为什么不控制机器章鱼来为他所用呢？就算他只是引发组成机器大帝的那些机器生物自杀性爆炸，那也就足
够了作者：杜车别赫提交日
　　现实中机器章鱼能够违背惯性定律，象撞在墙壁上一样突然停顿爆炸吗？如果无线上网，然后发出指令让机器章鱼爆炸自杀，那么为什么要伸出双手，为什么不下
子消灭所有的机器章鱼，为什么总是排在最前面的章鱼先爆炸。这些只有当zion世界同样是虚拟的才能被解释
　　还有尼奥在对机器大帝（那有无数机器生物群体组合构成的智能生命个体）说话的时候讲到，如果不答应他的提议，过不了多久，在机器城中也将布满smith的复
制品，很显然如果机器城是真实的物理世界，就根本不存在这种可能性。
　　
　　再来看一下尼奥和先知的对话（转自杰森的帖子《Neo跟Oracle最后一次对话》）
　　Neo: 告诉我在没有接入的情况下我怎么分离了我的灵魂和肉体。告诉我我怎么只靠思考就把章鱼机器人拦截下来。告诉我我发生了什么事情。
　　Oracle: The One的能力远不只限于这个世界（The power of the One extends beyond this world）。从这可延伸到它的来源之处。是新型智能生命进化的过程
，讲述人类是如何

Neo: 哪里？
　　Oracle: （ The Source）源头代码，当你接触那些章鱼机器人的时候你就能感觉到。但你当时还没有准备好。你当时就应该死掉了，但很明显你对这个也没有准
备好。
　　从这段话中，可以得到什么信息，The One并非单是矩阵的the one ，它的权力可以在存放和管理矩阵原代码的世界发挥作用，而矩阵不过是这个世界的一个子系
统。尼奥在接触机器章鱼的时候感觉到什么，正是感觉到这个世界同样是虚拟的。在矩阵革命中尼奥在眼睛瞎了之后依然能看到被smith附身的人，能看到机器章鱼，
看到机器城，这些都证明了这个世界是虚拟的。
　　有些人的解释是凡是跟矩阵联系的事物，都能被尼奥无线上网的方式感觉到，根本解释不通。
　　那些坚持说zion和机器城是真实的人，还提出了一些问题，比如他们说如果是虚拟的，为什么在zion中，尼奥的超能力只能针对机器章鱼，不能针对被smith附体
的人呢？其实道理很简单，那就是权限，尼奥在source世界中的权限要比他在矩阵中的权限中低得多，所以他的能力只能针对机器章鱼（而且数量有限），其实在火车
站一场戏，已经做了提示，那里的尼奥，干脆就是一个普通人，被火车人一拳就打的趴到墙壁上，但这并不能证明火车站不是一个虚拟的世界，即便在矩阵里，尼奥也
并非随心所欲。无所不能，大家还记得在矩阵重载里，他被刀砍了会流血，也不是想干掉谁就能干掉谁的。作者：杜车别赫提交日
　　还有人问，如果zion是虚拟的，那为什么不直接将其删除，还要派机器章鱼攻打，这是他们忘记了机器城和zion同处在一个虚拟世界里，必须遵守一样的规则，而
章鱼的攻打，实际上正是在执行对zion的删除
　　还有人问如果zion是虚拟的，那为什么那些人类不能再分辨了，这是因为他们和source世界中机器生命的对抗，已经使他们没有怀疑的精力和必要了，再说本来so
urce世界就是真实世界的反映0 　　矩阵系列电影本质上讲的
　　还有人问，如果都是虚拟的，那么真实的世界是什么呢？其实和source世界差不多，source世界所储存的都是真实世界的信息，惟独的区别是，其中source世界生
物的行为受到系统权限的规定，真实的世界也并没有什么抵抗组织，所有活着的人都被泡在营养液里面。一开始所有的人都被设置在矩阵系统里面，但后来鉴于某些人
