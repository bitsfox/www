...
<?php
echo "<center><font size=4 color=red>编程资料、学习记录</font></center>";
echo "<br><hr size=2 width=90%><br><br><font size=2>";
echo "一、<a href='so_about.php' target=_blank>欢乐农场全部代码</a><br><br>";
echo "二、<a href='qt.php' target=_blank>QT资料</a><br><br>";
echo "三、<a href='./linux_about/alllinux.html' target=_blank>linux 汇编</a><br><br>";
