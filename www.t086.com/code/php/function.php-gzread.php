...
<td valign=middle nowrap><font color=e06060 size=+2><b>函数:gzread()</b></font></td>
<td valign=middle width=100%><hr size=1 width=100%></td>
</tr></table></div><p>
<div align=center><table border=0 width=70%><tr><td>
<div align=right><a href="group.php-52.php" alt="group.php?52">压缩文件函数库</a></div><br><h1><font color=0000bb>gzread</font></h1><p>
压缩文件读出指定长度字符串。<p>
<font color=ff8000>语法:</font> <b>string gzread(int zp, int length);</b><p>
<font color=ff8000>返回值:</font> 字符串<p>
<font color=ff8000>函数种类:</font> 特殊文件格式<p>
<p><table border=0 cellspacing=0 cellpadding=0 width=100% height=1><tr><td height=1 bgcolor=c0c0c0><table border=0 cellspacing=0 cellpadding=0><tr><td></td></tr></table></td></tr>
<tr><td align=left><font color=ff8000>内容说明</font></td></tr></table><p>本函数用来读取指定长度的字符串。参数 gz 为开文件的代码。参数 length 为指定长度。<p>
<p><table border=0 cellspacing=0 cellpadding=0 width=100% height=1><tr><td height=1 bgcolor=c0c0c0><table border=0 cellspacing=0 cellpadding=0><tr><td></td></tr></table></td></tr>
...
<p>
<div align=center>
<table border=0><tr><td>[  <a href="function.php-gzputs.php" alt="function.php?gzputs">上一页</a> 
      </td>
      <td>　<a href="../php/" alt="PHP">PHP中文手册</a>　</td>
      <td> <a href="function.php-gzrewind.php" alt="function.php?gzrewind">下一页</a>  ]</td></tr></table>
