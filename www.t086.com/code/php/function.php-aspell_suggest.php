...
<title>PHP - 函数:aspell_suggest()</title>
...
<td valign=middle nowrap><font color=e06060 size=+2><b>函数:aspell_suggest()</b></font></td>
<td valign=middle width=100%><hr size=1 width=100%></td>
</tr></table></div><p>
<div align=center><table border=0 width=70%><tr><td>
<div align=right><a href="group.php-4.php" alt="group.php?4">拼写检查函数库</a></div><br><h1><font color=0000bb>aspell_suggest</font></h1><p>
检查一个单字，并提供拼写建议。<p>
<font color=ff8000>语法:</font> <b>array aspell_suggest(int dictionary_link, string word);</b><p>
<font color=ff8000>返回值:</font> 数组<p>
<font color=ff8000>函数种类:</font> 资料处理<p>
<p><table border=0 cellspacing=0 cellpadding=0 width=100% height=1><tr><td height=1 bgcolor=c0c0c0><table border=0 cellspacing=0 cellpadding=0><tr><td></td></tr></table></td></tr>
<tr><td align=left><font color=ff8000>内容说明</font></td></tr></table><p>本函数检查单字的拼写。并给予可能的拼法及正确的建议，以数组类型将结果返回。<p>
<p><table border=0 cellspacing=0 cellpadding=0 width=100% height=1><tr><td height=1 bgcolor=c0c0c0><table border=0 cellspacing=0 cellpadding=0><tr><td></td></tr></table></td></tr>
...
<div align=center>
  <table border=0>
    <tr>
      <td>[ <a href="function.php-aspell_check-raw.php" alt="function.php?aspell_check-raw">上一页</a> 
      </td>
      <td>　<a href="../php/" alt="PHP">PHP中文手册</a>　</td>
      <td> <a href="function.php-bcadd.php" alt="function.php?bcadd">下一页</a> 
        ]</td>
    </tr>
  </table>
