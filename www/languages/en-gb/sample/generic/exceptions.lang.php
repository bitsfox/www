...
*/
$LANG['SampleException'] 												= "发生样品相关的错误!";

$LANG['SampleIDMissingException'] 										= "样品标签丢失!";
$LANG['SampleNotFoundException'] 										= "没有找到要求的样品!";

$LANG['SampleCreateException'] 											= "不能建立样品记录!";

$LANG['SampleDeleteException'] 											= "不能删除样品记录!";
